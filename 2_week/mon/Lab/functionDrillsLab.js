...
console.log("Compare: ", compareNums(9, 1));
...
function nameCheck(NAMEPARAM) {
  switch (NAMEPARAM) {
    case "Steven":
      console.log(`What is up ${NAMEPARAM}?`);
      break;
    case "Bryan":
...
//CODE HERE
// ARROW FUNCTION WITH TERNARY STATEMENTS

// let faveColorFinder = (color) => {
//   return color === 'red' ? console.log(`${color} is a great color`) : color === 'green' ? console.log(`${color} is a solid favorite color`) : color === 'black' ? console.log('so trendy') : console.log('You need to evaluate your favorite color choice');
// }
...
function toUpperCase(string) {
  string = sampleString.toUpperCase();
  console.log(string);
}
...
function emailCheck(email) {
  ...
  if (email.includes("@")) {
    ...
    console.log("Must provide a valid e-mail address");
  }
}

let email = "   lyonel@live.com   ";
emailCheck(email);
...
// I DON'T HAVE THAT BUG BECAUSE I USED A FOR LOOP
...
let arrayIsAscending = ascOrDesc(sampleArray);
