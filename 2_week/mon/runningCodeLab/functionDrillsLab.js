...
let thatsOdd = (num) => {
  return num % 2 === 0 ? console.log(`That's not odd!`) : console.log(`That is odd indeed`);
}
...
let bestMovie = (MOVIEPARAM) => console.log(`${MOVIEPARAM} is the best movie ever!`); bestMovie('Interstellar');
